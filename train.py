...
tf.flags.DEFINE_string("input_data_file", "data.xlsx", "Data source for the input headlines data")
tf.flags.DEFINE_string("output_data_file", "output_file.xlsx", "Data source for the sentiment of the headlines")
...
# Load data
print("Loading data...")
x_text, y = data_helpers.load_data(FLAGS.input_data_file, FLAGS.output_data_file)
print(len(x_text))
# Build vocabulary
